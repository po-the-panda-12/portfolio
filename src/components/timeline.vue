...
export default {
  ...
  //
  // created() {
  //   window.addEventListener('scroll', this.fnOnScroll);
  //   window.addEventListener('resize', this.fnOnResize);
  // },
  //
  // methods: {
  //   fnOnScroll() {
  //     this.agPosY = window.scrollTop();
  //     this.fnUpdateFrame();
  //   },
  //
  //   fnOnResize() {
  //     this.agPosY = window.scrollTop();
  //     this.agHeight = window.height();
  //     this.fnUpdateFrame();
  //   },
  //
  //   fnUpdateWindow() {
  //     this.agFlag = false;
  //     agTimelineLine.css({
  //       top: this.agTimelineItem.first().find(this.agTimelinePoint).offset().top - this.agTimelineItem.first().offset().top,
  //       bottom: this.agTimeline.offset().top + this.agTimeline.this.outerHeight() - this.agTimelineItem.last().find(this.agTimelinePoint).offset().top
  //     });
  //
  //     f !== this.agPosY && (f = this.agPosY, this.agHeight, this.fnUpdateProgress());
  //   },
  //
  //   fnUpdateProgress() {
  //     var agTop = this.agTimelineItem.last().find(this.agTimelinePoint).offset().top;
  //
  //     var i = agTop + this.agPosY - window.scrollTop();
  //     var a = this.agTimelineLineProgress.offset().top + this.agPosY - window.scrollTop();
  //     var n = this.agPosY - a + this.agOuterHeight / 2;
  //     i <= this.agPosY + this.agOuterHeight / 2 && (n = i - a);
  //     this.agTimelineLineProgress.css({height: n + "px"});
  //
  //     agTimelineItem.each(function () {
  //       var agTop = this.find(agTimelinePoint).offset().top;
  //       (agTop + this.agPosY - window.scrollTop()) < this.agPosY + .5 * this.agOuterHeight ? this.addClass('js-ag-active') : this.removeClass('js-ag-active');
  //     })
  //   }
  //
  //
  ...
  //     this.agFlag || requestAnimationFrame(this.fnUpdateWindow);
  //     this.agFlag = true;
  //   }
  //
  // }
